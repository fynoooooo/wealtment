...
//     console.log("GET deposits response:", res);
//     setDeposits(res?? []);
//   } catch (err) {
...
//   // ==============================
//   // ✅ CORE FIX: USD is source
//   // ==============================
//   const usdVal = parseFloat(amount) || 0;
//   const minUsd = 1; // FIXED MINIMUM DEPOSIT
...
//          amount, // send USD amount to backend, backend will handle conversion and record keeping
//         coinType: coin,
//       });
...
//           </h1>
//           <p className="text-[var(--muted)] text-sm">
//             Enter USD and we convert to crypto
//           </p>
//         </div>
...
//           {/* Coin selector */}
//           <div>
//             <p className="text-[10px] uppercase text-[var(--muted)] mb-3">
//               Select Coin
//             </p>
...
//                     {META[c].icon}
//                   </div>
//                   <p className="font-bold text-sm">{META[c].label}</p>
//                 </button>
//               ))}
//             </div>
//           </div>
...
//               <button onClick={copy} className="text-xs mt-2 font-bold">
...
//             <div>
//               <p className="text-[10px] font-bold tracking-[1.5px] uppercase text-[var(--muted)] mb-2">Amount ({coin})</p>
//               <div className="relative">
                
//                 <input type="number" step="any"                 placeholder="Enter amount in USD (min $1)"
...
//               <span>Only send <strong className="text-[var(--red)]">{coin}</strong> to this address. Other coins will be lost permanently.</span>
//             </div>
...
//               {loading ? <><svg className="animate-spin w-4 h-4" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"/></svg> Submitting…</> : <><CheckCircle size={16}/> Submit Deposit</>}
//             </button>
//           </form>
//         </div>
...
//             <div className="p-4 font-semibold">My Deposits</div>

//             {deposits.slice(0, 5).map((d) => (
//               <div
//                 key={d._id}
//                 className="flex justify-between p-3 text-sm border-t"
//               >
//                 <div>
